...
const renderCarrito = () => {
        ...
        const productoAnteriores = ventanaCarrito.querySelectorAll('.carrito__producto');
...
btnAgregarCarrito.addEventListener('click', (e) => {
        ...
        // Establecemos la ruta de la imagen que vamos a querer mostras.
        let thumbSrc = producto.querySelectorAll('.producto__thumb-img')[0].src;
        if (color === 'rojo') {
            thumbSrc = './img/thumbs/rojo.jpg';
        ...
        // Despues de 5 segunfo la ocultamos.
        setTimeout(() => {
